...
// // 인스턴스 객체의 프로토타입을 확인!! 속성 __proto__

// console.log(Book.prototype);
// // 인스턴스 객체의 조상이 되는 프로토타입 객체를 생성해준 생성자 함수가 가지고 있는 속성 및 메서드 함수를 확인해보고자 할 때 !

// 상속에 대한 개념을 설명하기 전, 인스턴스 객체의 기원을 찾는 방법
// 찾은 해당 기원의 속성을 확인, prototype
// 객체 선언

// 키 값에 접근할 때 1) 온점 표기법 / 2) 대괄호 표기법
...
const book2 = new TextBook("잘 될 거야!", 20000, "인생");
